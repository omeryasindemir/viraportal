...
const Apps = () => {
    ...
    return (
        <div style={{display: "flex", gap: 8}}>
            <div style={{ display: "flex", flexDirection: "column", gap: 32, paddingTop: 32, width: "100%", maxWidth: 360, height: 360, justifyContent: "space-between" }} className="tBox">
                <div style={{display: "flex", flexDirection: "column", gap: 32}}>
                    <div style={{ textAlign: "center" }}><i style={{ fontSize: 64 }} className="bi bi-bezier2"></i></div>
                    <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                        <div style={{ textAlign: "center", display: "flex", gap: 16, justifyContent: "center", alignItems: "center" }} className='midium_text'>virafic<span style={{ color: "gold" }} className='des_text'>4/5 <i class="bi bi-star-fill"></i></span></div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 32, paddingTop: 32, width: "100%", maxWidth: 360, height: 360, justifyContent: "space-between" }} className="tBox">
                <div style={{display: "flex", flexDirection: "column", gap: 32}}>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                        <div style={{ textAlign: "center", display: "flex", gap: 16, justifyContent: "center", alignItems: "center" }} className='midium_text'>viracommerce<span style={{ color: "gold" }} className='des_text'>4/5 <i class="bi bi-star-fill"></i></span></div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 32, paddingTop: 32, width: "100%", maxWidth: 360, height: 360, justifyContent: "space-between" }} className="tBox">
                <div style={{display: "flex", flexDirection: "column", gap: 32}}>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                        <div style={{ textAlign: "center", display: "flex", gap: 16, justifyContent: "center", alignItems: "center" }} className='midium_text'>viramc<span style={{ color: "gold" }} className='des_text'>4/5 <i class="bi bi-star-fill"></i></span></div>
